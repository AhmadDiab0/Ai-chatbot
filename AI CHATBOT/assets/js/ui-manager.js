...
const UIManager = {
  ...
  showWelcomeMessage: () => {
    ...
    // Eerst oude welcome messages verwijderen, mocht die per ongeluk blijven hangen
  ...
  // Alleen 1 chat per gebruiker, dus altijd die laden!
  ...
  // Geen chatlijst, geen actieve chatitems updaten nodig
