...
fileInput.addEventListener("change", () => {
  ...
  if (file.size > maxSize) {
    alert("Bestand is te groot. Maximaal 8 MB toegestaan.");
    fileInput.value = "";
    return;
  }
